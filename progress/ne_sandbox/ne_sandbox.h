...
// applied.
NE_CORE_API uint64_t (*ne_sandbox_api_major)(uint64_t *result);

// Get the minor version of the API. Between minor versions features are added.
NE_CORE_API uint64_t (*ne_sandbox_api_minor)(uint64_t *result);
