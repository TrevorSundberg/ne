...
NE_DECLARE_PACKAGE(ne_display, 0, 0);

NE_API uint64_t (*ne_display_count)(uint64_t *result);
...
NE_API uint64_t (*ne_display_get_mode)(uint64_t *result, uint64_t display_index,
                                       ne_display_mode *mode_out);

// Enumerator dereference takes 'ne_display_mode*'.
NE_API void (*ne_display_mode_enumerator)(uint64_t *result,
