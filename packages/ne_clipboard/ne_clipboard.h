...
NE_API const char *(*ne_clipboard_get_text)(uint64_t *result,
                                            ne_clipboard_texttype texttype);

// May result in 'ne_clipboard_result_texttype_not_supported'.
NE_API void (*ne_clipboard_set_text)(uint64_t *result, const char *text,
                                     ne_clipboard_texttype texttype);
...
NE_API void (*ne_clipboard_get_image_rgba32f)(uint64_t *result,
                                              ne_clipboard_image *image);

NE_API void (*ne_clipboard_set_image_rgba32f)(uint64_t *result,
                                              ne_clipboard_image *image);
