...
// Since you are guaranteed at least 1 timer, index 0 is always valid and has the highest frequency.
...
//      The timer provided was greater or equal to the value returned from 'ne_timer_count'.
