...
NE_CORE_API void (*ne_window_set_bordered_rectangle)(uint64_t *result,
...
NE_CORE_API void (*ne_window_get_client_rectangle)(
    uint64_t *result, ne_window_rectangle *rectangle_out);
NE_CORE_API void (*ne_window_set_client_rectangle)(uint64_t *result,
                                              ne_window_rectangle *rectangle);
...
NE_CORE_API void (*ne_window_get_minimum_client_size)(uint64_t *result,
                                                 uint64_t *x_out,
                                                 uint64_t *y_out);
NE_CORE_API void (*ne_window_set_minimum_client_size)(uint64_t *result, uint64_t x,
                                                 uint64_t y);
...
NE_CORE_API void (*ne_window_get_maximum_client_size)(uint64_t *result,
                                                 uint64_t *x_out,
                                                 uint64_t *y_out);
NE_CORE_API void (*ne_window_set_maximum_client_size)(uint64_t *result, uint64_t x,
                                                 uint64_t y);
...
NE_CORE_API void (*ne_window_set_flags)(uint64_t *result, ne_window_flags flags);
...
NE_CORE_API void (*ne_window_set_state)(uint64_t *result, ne_window_state state);

// Get an index for the display that primarily owns the window.
NE_CORE_API uint64_t (*ne_window_display)(uint64_t *result, ne_window_state state);
