...
NE_DECLARE_PACKAGE(ne_window, 0, 0);

typedef struct ne_window ne_window;

// The rectangle's origin is the top left corner.
...
NE_API ne_window *(*ne_window_create)(uint64_t *result);

NE_API void (*ne_window_free)(uint64_t *result, ne_window *window);
...
// rectangle.
NE_API void (*ne_window_get_bordered_rectangle)(
    uint64_t *result, ne_window_rectangle *rectangle_out);
NE_API void (*ne_window_set_bordered_rectangle)(uint64_t *result,
                                                ne_window_rectangle *rectangle);

// Returns the rectangle of the window's client-area in display space (origin is
// top left).
NE_API void (*ne_window_get_client_rectangle)(
    uint64_t *result, ne_window_rectangle *rectangle_out);
NE_API void (*ne_window_set_client_rectangle)(uint64_t *result,
                                              ne_window_rectangle *rectangle);

// Set the minimum size of the client area.
NE_API void (*ne_window_get_minimum_client_size)(uint64_t *result,
                                                 uint64_t *x_out,
                                                 uint64_t *y_out);
NE_API void (*ne_window_set_minimum_client_size)(uint64_t *result, uint64_t x,
                                                 uint64_t y);

// Set the maximum size of the client area.
NE_API void (*ne_window_get_maximum_client_size)(uint64_t *result,
                                                 uint64_t *x_out,
                                                 uint64_t *y_out);
NE_API void (*ne_window_set_maximum_client_size)(uint64_t *result, uint64_t x,
                                                 uint64_t y);
...
NE_API ne_window_flags (*ne_window_get_flags)(uint64_t *result);
NE_API void (*ne_window_set_flags)(uint64_t *result, ne_window_flags flags);
...
NE_API ne_window_state (*ne_window_get_state)(uint64_t *result);
NE_API void (*ne_window_set_state)(uint64_t *result, ne_window_state state);

// Get an index for the display that primarily owns the window.
NE_API uint64_t (*ne_window_display)(uint64_t *result, ne_window_state state);

NE_API const char *(*ne_window_get_title)(uint64_t *result);
NE_API void (*ne_window_set_title)(uint64_t *result, const char *title);

NE_API float (*ne_window_get_opacity)(uint64_t *result);
NE_API void (*ne_window_set_opacity)(uint64_t *result, float opacity);

NE_API float (*ne_window_get_progress)(uint64_t *result);
NE_API void (*ne_window_set_progress)(uint64_t *result, float progress);
