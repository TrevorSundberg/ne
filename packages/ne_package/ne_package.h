...
NE_CORE_API void (*ne_package_symbol_enumerator)(uint64_t *result,
...
// returned.
NE_CORE_API ne_package *(*ne_package_load)(uint64_t *result, ne_package_info *info);
...
NE_CORE_API void (*ne_package_open_file)(uint64_t *result, ne_package *package,
                                    const char *filename,
...
NE_CORE_API void *(*ne_package_symbol_find)(uint64_t *result, ne_package *package,
                                       const char *name);
