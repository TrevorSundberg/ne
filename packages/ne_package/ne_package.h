...
NE_API void (*ne_package_symbol_enumerator)(uint64_t *result,
...
// requested).
NE_API ne_core_bool (*ne_package_exists)(uint64_t *result,
...
NE_API ne_package *(*ne_package_load_from_stream)(uint64_t *result,
                                                  ne_package_info *info,
...
NE_API void (*ne_package_open_file)(uint64_t *result, ne_package *package,
                                    const char *filename,
...
NE_API void *(*ne_package_symbol_find)(uint64_t *result, ne_package *package,
                                       const char *name);
