...
NE_API ne_thread *(*ne_thread_enumerate_next)(uint64_t *result,
                                              ne_thread *current);
...
NE_API ne_thread *(*ne_thread_create)(uint64_t *result,
                                      ne_thread_routine routine, void *data,
                                      ne_thread_mode mode, const char *name);
...
NE_API ne_core_bool (*ne_thread_wait)(uint64_t *result, ne_thread *thread,
...
NE_API void (*ne_thread_set_priority)(uint64_t *result, ne_thread *thread,
...
NE_API void *(*ne_thread_storage_get)(uint64_t *result,
                                      ne_thread_storage_id id);
NE_API void (*ne_thread_storage_set)(uint64_t *result, ne_thread_storage_id id,
                                     void *data);
...
NE_API ne_core_bool (*ne_thread_mutex_lock)(uint64_t *result,
...
NE_API void (*ne_thread_event_create)(uint64_t *result, ne_core_bool signaled,
...
NE_API void (*ne_thread_event_set_signalled)(uint64_t *result,
