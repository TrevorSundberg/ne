...
NE_CORE_API ne_core_bool (*ne_thread_wait)(uint64_t *result, ne_thread *thread,
...
NE_CORE_API const char *(*ne_thread_get_name)(uint64_t *result, ne_thread *thread);
...
NE_CORE_API void (*ne_thread_set_priority)(uint64_t *result, ne_thread *thread,
...
NE_CORE_API void (*ne_thread_storage_set)(uint64_t *result, ne_thread_storage_id id,
                                     void *data);
...
NE_CORE_API ne_thread *(*ne_thread_get_next)(uint64_t *result, ne_thread *thread);
...
NE_CORE_API void (*ne_thread_event_create)(uint64_t *result, ne_core_bool signaled,
