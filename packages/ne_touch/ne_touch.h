...
/// Represents a specific finger in a touch event and gives the coordinates
...
NE_CORE_API uint64_t (*ne_touch_finger_count)(uint64_t *result,
                                              uint64_t device);

NE_CORE_API void (*ne_touch_get_finger)(uint64_t *result,
                                        uint64_t device,
                                        uint64_t finger,
