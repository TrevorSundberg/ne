...
NE_API uint64_t (*ne_sandbox_communicate)(uint64_t* result, void* buffer, uint64_t size);
...
NE_API void (*ne_sandbox_terminate)(uint64_t* result, uint64_t code, const char* message);
